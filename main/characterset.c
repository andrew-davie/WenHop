...
const unsigned char *const charSet[CH_MAX] = {
    ...
    C(__CHAR_BOULDER),                // 009 CH_BOULDER,
    C(__CHAR_BOULDER),                // 010 CH_BOULDER_FALLING,
    ...
    C(__CHAR_DOGE_PEBBLE),            // 025 CH_PEBBLE_BOULDER,
    ...
    C(__CHAR_BOULDER_DOGE),           // 035 CH_CONGLOMERATE,
    C(__CHAR_BOULDER_U),              // 036 CH_CONGLOMERATE_1,
    C(__CHAR_BOULDER_R),              // 037 CH_CONGLOMERATE_2,
    C(__CHAR_BOULDER_UR),             // 038 CH_CONGLOMERATE_3,
    C(__CHAR_BOULDER_D),              // 039 CH_CONGLOMERATE_4,
    C(__CHAR_BOULDER_UD),             // 040 CH_CONGLOMERATE_5,
    C(__CHAR_BOULDER_RD),             // 041 CH_CONGLOMERATE_6,
    C(__CHAR_BOULDER_URD),            // 042 CH_CONGLOMERATE_7,
    C(__CHAR_BOULDER_L),              // 043 CH_CONGLOMERATE_8,
    C(__CHAR_BOULDER_UL),             // 044 CH_CONGLOMERATE_9,
    C(__CHAR_BOULDER_RL),             // 045 CH_CONGLOMERATE_10,
    C(__CHAR_BOULDER_URL),            // 046 CH_CONGLOMERATE_11,
    C(__CHAR_BOULDER_DL),             // 047 CH_CONGLOMERATE_12,
    C(__CHAR_BOULDER_UDL),            // 048 CH_CONGLOMERATE_13,
    C(__CHAR_BOULDER_RDL),            // 049 CH_CONGLOMERATE_14,
    C(__CHAR_BOULDER_URDL),           // 050 CH_CONGLOMERATE_15,
    ...
    C(__CHAR_AMOEBA_0),               // 067 CH_WYRM_BODY,
    C(__CHAR_AMOEBA_2),               // 068 CH_WYRM_VERT_BODY,
    ...
    C(__CHAR_BOULDER_URDL2),          // 093 CH_CONGLOMERATE_MID,
    C(__CHAR_BOULDER_DOGE),           // 094 CH_BOULDER_DOGE,
    C(__CHAR_BOULDER_DOGE),           // 095 CH_BOULDER_DOGE_FALLING,
