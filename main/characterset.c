...
const unsigned char *const charSet[CH_MAX] = {
   ...
   // see ChName @ attribute.h
    ...
    C(__CHAR_FLIP_GRAVITY_0),       // CH_GRAVITY,                     // 096
    C(__CHAR_FLIP_GRAVITY_1),       // CH_GRAVITY,                     // 097
    C(__CHAR_FLIP_GRAVITY_2),       // CH_GRAVITY,                     // 098
    C(__CHAR_HORIZ_ZAP_0),          // CH_HORIZ_ZAP_0,                 // 099
    C(__CHAR_HORIZ_ZAP_1),          // CH_HORIZ_ZAP_1,                 // 100
    C(__CHAR_HORIZ_ZAP_2),          // CH_HORIZ_ZAP_1,                 // 101
    C(__CHAR_BLOCK),                // CH_BLOCK,                       // 102
    C(__CHAR_PACMAN_DOT),           // CH_PACMAN_DOT,                  // 103
    C(__CHAR_HORIZ_ZAP_3),          // CH_HORIZ_ZAP_3,                 // 104
    C(__CHAR_HUB),                  // CH_HUB,                         // 105
    C(__CHAR_BLANK), //C(__CHAR_WATER_0),              // CH_WATER_0,                     // 106
    C(__CHAR_BLANK), //C(__CHAR_WATER_1),              // CH_WATER_1,                     // 107
    C(__CHAR_BLANK), //C(__CHAR_WATER_2),              // CH_WATER_2,                     // 108
    C(__CHAR_BLANK), //C(__CHAR_WATER_3),              // CH_WATER_3,                     // 109
};
