...
// Raw queue pointers
void *const _QUE = (void *)0x40000800ULL;
#define _QUEUE ((unsigned char *)_QUE)
#define _QUEUE_INT ((unsigned int *)_QUE)
#define _QUEUE_SINT ((unsigned short int *)_QUE)

void *DDR = (void *)0x40000800ULL;
...
// Queue variables
unsigned int *const _QPTR = (unsigned int *)0x40000098ULL;
unsigned int *const _QINC = (unsigned int *)0x40000124ULL;
unsigned int *const _WAVEFORM = (unsigned int *)0x400001B0ULL;
unsigned char *_FF_OFFSET = (unsigned char *)0x400003E0ULL;
...
static void setPointerFrac(const int fetcher, const unsigned int offset, const unsigned int frac) {
    _QPTR[fetcher] = (offset << 16) | (frac << 8);
}

// Set fetcher increment
static void setIncrement(const int fetcher, const unsigned char whole, const unsigned char frac) {
...
static void setSamplePtr(unsigned int address) { _WAVEFORM[0] = address; }
